...
import { updateUser, seedDemoData } from '../../../services/UserServices/UserService';
...
const ProfilePage: React.FC = () => {
    ...
    const handleAddDemoData = async () => {
        try {
            await seedDemoData();
            showNotification('Demo data added! Refreshing...', 'success');
            // Refresh data
            fetchLogs();
            // Force reload to refresh follower component (since it fetches on mount)
            setTimeout(() => window.location.reload(), 1000);
        } catch (error) {
            console.error("Failed to add demo data", error);
            showNotification('Failed to add demo data', 'error');
        }
    };
            ...
            <div className="profile-header">
                ...
                <div className="profile-info">
                    ...
                    <div style={{ display: 'flex', gap: '10px', marginTop: '10px' }}>
                        ...
                        <Button onClick={handleAddDemoData}>
                            Add Demo Data
                        </Button>
                    </div>
                </div>
