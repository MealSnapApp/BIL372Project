...
router.delete('/unfollow/:followed_user_id', authenticateToken, FollowerController.unfollow);
...
router.get('/is-following/:followed_user_id', authenticateToken, FollowerController.isFollowing);
